...
describe('TabsStore', () => {
  ...
  describe('Tab Management', () => {
    ...
    it('should set active tab', () => {
      const store = useTabsStore.getState();
      const tab1: Tab = { id: 'tab-1', title: 'Tab 1', url: 'https://example.com' };
      const tab2: Tab = { id: 'tab-2', title: 'Tab 2', url: 'https://google.com' };
    ...
    it('should not remove pinned tabs', () => {
      const store = useTabsStore.getState();
      const tab: Tab = { id: 'tab-1', title: 'Tab 1', url: 'https://example.com', pinned: true };
  ...
  describe('History Navigation', () => {
    it('should navigate tab and add to history', () => {
      const store = useTabsStore.getState();
      const tab: Tab = { id: 'tab-1', title: 'Tab 1', url: 'https://example.com' };
