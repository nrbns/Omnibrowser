      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 bottom-0 w-[420px] max-w-[90vw] sm:max-w-full bg-[var(--surface-root)] backdrop-blur-xl border-l border-[var(--surface-border)] z-50 flex flex-col shadow-2xl"
            role="dialog"
            aria-modal="true"
