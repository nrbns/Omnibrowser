...
export function registerAgentIpc(): void {
  ...
  registerHandler('agent:generatePlanFromGoal', z.object({
    goal: z.string(),
  ...
  registerHandler('agent:executePlan', z.object({
    planId: z.string(),
    plan: z.object({
      id: z.string(),
      goal: z.string(),
  ...
  registerHandler('agent:guardrails:config', z.object({
    promptFirewall: z.object({
      enabled: z.boolean(),
  ...
  // Guardrails check
  registerHandler('agent:guardrails:check', z.object({
